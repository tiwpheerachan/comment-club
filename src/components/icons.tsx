// ไอคอน SVG แบบ inline (stroke = currentColor) ไม่พึ่งไลบรารีภายนอก
type Props = { className?: string };

const base = "stroke-current fill-none [stroke-width:1.8] [stroke-linecap:round] [stroke-linejoin:round]";

function make(path: React.ReactNode) {
  return function Icon({ className = "w-[18px] h-[18px]" }: Props) {
    return (
...
export const Scale = make(
  <>
    ...
    <path d="M19 7l3 6a4 4 0 0 1-6 0z" />
  </>
);
...
export const Wrench = make(
  <path d="M14.7 6.3a4 4 0 0 0-5.4 5.3L3 18v3h3l6.4-6.3a4 4 0 0 0 5.3-5.4l-2.9 2.9-2.1-2.1z" />
);
