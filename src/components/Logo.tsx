  ...
  return (
    <div className="flex items-stretch gap-2 text-cc select-none" aria-label="commentclub">
      ...
      <div className={`leading-none whitespace-nowrap ${animate ? "cc-reveal" : ""}`}>
        <span className="font-script align-baseline" style={{ fontSize: scriptSize, lineHeight: 1 }}>comment</span>
        <span className="font-display font-semibold tracking-tight align-baseline -ml-[2px]" style={{ fontSize: clubSize }}>club</span>
      </div>
    </div>
  );
}
